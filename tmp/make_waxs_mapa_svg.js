...
svg += `<text x="${w/2}" y="50" fill="#ffffff" font-family="Arial" font-size="28" font-weight="bold" text-anchor="middle">Figura 1.13b: Como o WAXS mapeia a Córnea</text>`;
...
svg += `<text x="80" y="${cy+60}" fill="#00e5ff" font-family="Arial" font-size="16" font-weight="bold" text-anchor="middle">Feixe de Raios-X</text>`;
...
svg += `<text x="430" y="120" fill="#ffeb3b" font-family="Arial" font-size="18" font-weight="bold" text-anchor="middle">Anterior (30%)</text>`;
...
svg += `<text x="500" y="90" fill="#ff5252" font-family="Arial" font-size="20" font-weight="bold" text-anchor="middle">Posterior (70%)</text>`;
...
svg += `<text x="840" y="530" fill="#ffffff" font-family="Arial" font-size="18" font-weight="bold" text-anchor="middle">Padrão de Difração (WAXS)</text>`;

// Note
svg += `<text x="${cx}" y="570" fill="#cfd8dc" font-family="Arial" font-size="14" text-anchor="middle">O sinal final lido pelo WAXS representa predominantemente (80% do sinal) a organização das lamelas do estroma posterior.</text>`;
