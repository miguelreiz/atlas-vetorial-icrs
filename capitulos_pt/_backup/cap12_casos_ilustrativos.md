...
$V\tau$ validado = $9,31\ \mu\text{N}\cdot\text{m}$ (linear progressivo, da Tabela 12.2a). Migração esperada do ápice ≈ 0,3–0,5 mm em direção ao eixo visual. Combinado com aplanamento moderado (ΔK ≈ 1,5–2,0 D). Dada a classificação O−, o paciente deve entender que a melhora da AVMC pode ser modesta, mesmo com o reposicionamento bem-sucedido do ápice.
