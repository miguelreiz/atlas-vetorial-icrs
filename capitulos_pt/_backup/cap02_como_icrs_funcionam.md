...
Esta constatação biomecânica tem uma implicação clínica transformadora: **os ICRS não aplanam a córnea por bloquearem o deslocamento apical (já que a restrição isolada aumenta esse abaulamento). Eles aplanam a córnea devido à adição de volume periférico, enquanto redistribuem a tensão através do seu arco rígido.** O $\Delta$K clínico que o cirurgião refrativo observa advém da relação local de volumes e da modelagem da superfície (Vetor Vertical).
