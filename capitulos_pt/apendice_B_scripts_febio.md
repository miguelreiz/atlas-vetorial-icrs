...
| Extensão angular (θ_{max}) | 46,5° | Do ápice ao limbo |
...
O ICRS é posicionado no anel 14 (r ≈ 4,2 mm do ápice), correspondendo à zona óptica de 5–6 mm típica dos implantes comerciais (Intacs, Ferrara, Keraring).
...
|:---|:---:|:---|:---:|
| Deslocamento apical | δ_{apex} | Deslocamento uz no nó 1 (ápice) | VR |
| Deslocamento radial | δ_ring | Média de deslocamento radial no anel ICRS | VT |
| Variação ceratométrica | Δ K | Mudança no poder refrativo (D) | VR |
| Deformação circunferencial | ε_{circ} | Strain tangencial médio no anel | VT |
| Tensão máxima | σ_{max} | Tensão de von Mises máxima (MPa) | — |
| Índice de assimetria | AI | Assimetria do campo de deslocamento | Vτ |
| Meridiano mais plano | θ_{flat} | Direção de máximo aplanamento (°) | — |
| Meridiano mais curvo | θ_{steep} | Direção de máxima curvatura (°) | — |
...
2. **Variância Explicada:** Decompõe a variância total do δ_{apex} por parâmetro.
...
| Parâmetro | CV de δ_{apex} | Variância Explicada |
|:---:|:---:|:---:|
| c (matriz) | **0,671** | **98,9%** |
