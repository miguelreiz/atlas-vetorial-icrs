...
![Figura 3.3: Mapa WAXS Quantitativo — Densidade fibrilar por 8 setores e 3 zonas concêntricas. Destaque para o déficit de -44% no setor IT (240°) vs. eixo N-T. O IT é o "vão" da malha.](../../images/CH-003_Classificacao/Figura_3.3_WAXS_Quantitativo.png)
...
![Figura 3.4: Carga Mecânica Acumulada — Simulação de 10 anos com forças palpebral, rubbing e sono. Pico convergente no quadrante IT (240–270°), zona paracentral.](../../images/CH-003_Classificacao/Figura_3.4_Forcas_Externas.png)
...
![Figura 3.4: Mapa de Forças Externas — Soma vetorial da pressão palpebral, eye rubbing e compressão noturna, todas convergindo para o setor Inferotemporal.](../../images/CH-003_Classificacao/Figura_3.4_Forcas_Externas.png)

![Figura 3.5: Mapa Molecular e Genético — Densidade de ceratócitos, crosslinks e expressão de MMP-9 convergindo na zona de maior estresse (IT).](../../images/CH-003_Classificacao/Figura_3.5_Molecular_IT.png)

![Figura 3.6: Sinais Clínicos como Reflexo Biomecânico — Sinal de Munson, Estrias de Vogt e Anel de Fleischer explicados estruturalmente pela falha do tecido na região inferotemporal.](../../images/CH-003_Classificacao/Figura_3.6_Sinais_Clinicos.png)

![Figura 3.7: Deslocamento FEM FEBio — Mapa de calor gerado pelo FEBio mostrando córnea sob IOP de 15mmHg com déficit IT de -44%. O ápice de deslocamento coincide perfeitamente com a localização clínica do cone.](../../images/CH-003_Classificacao/Figura_3.7_FEBio_Deslocamento.png)

![Figura 3.8: Pré/Pós ICRS IT — Dois painéis comparando V_cone (pré-ICRS) vs. anel assimétrico IT com VR, Vτ e VComa (pós-ICRS). V_anel = −V_cone.](../../images/CH-003_Classificacao/Figura_3.8_Icrs_IT.png)
