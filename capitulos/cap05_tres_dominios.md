...
2. **Refractive Surgery (LASIK/PRK) Candidates (N = 352 eyes):** In patients undergoing corneal laser refractive surgery, the incidence of severe post-operative visual symptoms (glare, halos, starbursts) was 18.2\% in the ICE Alto group vs. 76.9\% in the ICE Baixo group. Post-operative vertical coma was more than 2.5-fold higher in the low-coherence cohort (0.71 \pm 0.33 μm vs. 0.28 \pm 0.14 μm, p < 0.001). Pearson correlation between ICE_min and visual outcomes was r = -0.58 (p < 0.001).
