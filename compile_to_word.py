...
def add_cover_page(doc):
    ...
    run_title = p_title.add_run("Corneal Biomechanical Vector Analysis (AVBC)")
    ...
    run_sub = p_sub.add_run("Corneal Biomechanical Force Vectors for Intrastromal Corneal Ring Segment Implantation")
    ...
    run_ed_lbl = p_editor_label.add_run("Lead Editor")
    ...
    run_editor = p_editor.add_run("Main Author: Dr. Miguel Reis\nCo-author: Dra. Jordana Sandes")
    ...
    for idx, filepath in enumerate(chapter_files):
        ...
        while line_idx < total_lines:
            ...
            if img_match:
                ...
                # PNG is already generated by the PT script
                if img_path.lower().endswith('.svg'):
                    img_path = img_path.rsplit('.', 1)[0] + '.png'
...
if __name__ == "__main__":
    ...
    # Path settings
    output_docx = os.path.join(script_dir, "Analise_Vetorial_Biomecanica_Corneana.docx")
    
    chapters = [
        os.path.join(script_dir, "capitulos", "indice_geral.md"),
        os.path.join(script_dir, "capitulos", "cap01_cornea_biomecanica.md"),
        os.path.join(script_dir, "capitulos", "cap02_como_icrs_funcionam.md"),
        os.path.join(script_dir, "capitulos", "cap03_metodo_alpins.md"),
        os.path.join(script_dir, "capitulos", "cap04_limites_nomogramas.md"),
        os.path.join(script_dir, "capitulos", "cap05_tres_dominios.md"),
        os.path.join(script_dir, "capitulos", "cap06_vetor_VR.md"),
        os.path.join(script_dir, "capitulos", "cap07_vetor_VT.md"),
        os.path.join(script_dir, "capitulos", "cap08_vetor_Vtau.md"),
        os.path.join(script_dir, "capitulos", "cap09_classificacao_avbc.md"),
        os.path.join(script_dir, "capitulos", "cap10_validacao_fem.md"),
        os.path.join(script_dir, "capitulos", "cap11_fluxo_clinico.md"),
        os.path.join(script_dir, "capitulos", "cap12_casos_ilustrativos.md"),
        os.path.join(script_dir, "capitulos", "cap13_limitacoes_futuro.md"),
        os.path.join(script_dir, "capitulos", "cap14_plataforma_software.md"),
        os.path.join(script_dir, "capitulos", "cap15_conclusao.md"),
        os.path.join(script_dir, "capitulos", "proposta_elsevier_avbc.md")
    ]
